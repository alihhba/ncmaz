...
import ProjectFilter from "@/panels/customer/pages/projects/components/Filter";
import useResourceAction from "@/hooks/useResourceAction";

export const ProjectList = ({resource = "projects", filters: providedFilters = [], withoutActions = false}) => {
                ...
                >
                    ...
                    <List.Container>
                        <List.Header.Container>
                            ...
                            <List.Header.Data.Text>Quota</List.Header.Data.Text>
                        ...
                        <List.Body.Container>
                            {items.map(({id, ...restItemProps}) => (
                                <ProjectListItem resource={resource} key={id} id={id} withoutActions={withoutActions} {...restItemProps} />
                            ))}
                        </List.Body.Container>
                    </List.Container>
