                    ...
                    <List.Container>
                        ...
                        <List.Body.Container>
                            {items.map(({id, ...restItemProps}) => (
                                <DocumentListItem key={id} id={id} resource={resource} data={{id, ...restItemProps}}/>
                            ))}
                        </List.Body.Container>
                    </List.Container>
