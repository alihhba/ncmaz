import convertNumbThousand from "@/utils/ConvertNumberThousand";
import twFocusClass from "@/utils/twFocusClass";
import React from "react";

const CommentCardLikeReply = ({
  className = "",
  likeCount,
  isLiked,
  commentId,
  ...
  return (
    <div
      className={`nc-CommentCardLikeReply flex items-center gap-x-2 ${className}`}
